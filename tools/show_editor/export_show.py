...
EFFECT_IDS = {
    ...
    "strobe": SHOW_EFFECT_STROBE,
    "fade": SHOW_EFFECT_FADE,
    "sweep": SHOW_EFFECT_SWEEP,
    "mirror_sweep": SHOW_EFFECT_MIRROR_SWEEP,
    "chase": SHOW_EFFECT_CHASE,
    "gradient": SHOW_EFFECT_GRADIENT,
    "sparkle": SHOW_EFFECT_SPARKLE,
    "fanout": SHOW_EFFECT_FANOUT,
    "palette_cycle": SHOW_EFFECT_PALETTE_CYCLE,
    "global_plane_sweep": SHOW_EFFECT_GLOBAL_PLANE_SWEEP,
    "traveling_orb": SHOW_EFFECT_TRAVELING_ORB,
    "ring_burst": SHOW_EFFECT_RING_BURST,
